    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.FloatField(validators=[django.core.validators.MinValueValidator(99),
                                                        django.core.validators.MaxValueValidator(9999999)])),
                ('in_stock', models.IntegerField(default=0)),
                ('color', models.CharField(max_length=45)),
                ('size', models.CharField(choices=[('XL', 'XL'), ('L', 'L'), ('XXL', 'XXL'), ('M', 'M'), ('S', 'S')],
                                          max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=15,
                                           validators=[django.core.validators.RegexValidator('^[6-9]{1}\\d{9}$')])),
                ('address', models.TextField()),
                ('landmark', models.CharField(blank=True, max_length=45, null=True)),
                ('city', models.CharField(max_length=45)),
                ('pincode', models.IntegerField(validators=[django.core.validators.MinValueValidator(111111),
